...
public class ChatFragment extends ListFragment {
    ...
    MainApp mApp = null;
    private static ChattingActivity mActivity = null;

    private ArrayList<MessagingTuple> mMessageList = null;   // a list of chat msgs.
    private ArrayAdapter<MessagingTuple> mAdapter= null;
    ...
    public static ChatFragment newInstance(Activity activity, String groupOwnerAddr, String msg) {
        ...
        mActivity = (ChattingActivity) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MessagingTuple row = new MessagingTuple(mApp.mDeviceName, inputMsg, null);
        ...
        if( savedInstanceState != null ){
            ...
            mMessageList = new ArrayList<MessagingTuple>();
     ...
     */
    public void appendChatMessage(MessagingTuple row) {
    ...
    private void jsonArrayToList(JSONArray jsonarray, List<MessagingTuple> list) {
        try{
            for(int i=0;i<jsonarray.length();i++){
                MessagingTuple row = MessagingTuple.parseMesssageRow(jsonarray.getJSONObject(i));
     ...
     */
    final class ChatMessageAdapter extends ArrayAdapter<MessagingTuple> {
        ...
        public ChatMessageAdapter(Context context, List<MessagingTuple> objects){
        ...
        public int getItemViewType(int position) {
            MessagingTuple item = this.getItem(position);
