...
public class ConnectionService extends Service implements ChannelListener, PeerListListener, ConnectionInfoListener{
    ...
    MainApp mApp;
    ChattingActivity mActivity;    // shall I use weak reference here ?
    ...
    private void processIntent(Intent intent){
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {  // this devices's wifi direct enabled state.
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ...
                mApp.mP2pChannel = mApp.mP2pMan.initialize(this, mWorkHandler.getLooper(), null);
                SystemPref.setStringToPref(mApp, SystemPref.PREF_NAME, SystemPref.P2P_ENABLED, "1");
                ...
                SystemPref.setStringToPref(mApp, SystemPref.PREF_NAME, SystemPref.P2P_ENABLED, "0");
            }
    ...
    private void processMessage(android.os.Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_REGISTER_ACTIVITY:
                ...
                onActivityRegister((ChattingActivity)msg.obj, msg.arg1);
                break;
     ...
     */
    private void onActivityRegister(ChattingActivity activity, int register){
    ...
    private String onPullInData(SocketChannel schannel, Bundle b){
        ...
        MessagingTuple row = MessagingTuple.parseMessageRow(data);
     ...
     */
    public void showNotification(MessagingTuple row) {
        ...
        Intent notificationIntent = mApp.getLauchActivityIntent(ChattingActivity.class, row.mMsg);
     ...
     */
    private void showInActivity(final MessagingTuple row){
